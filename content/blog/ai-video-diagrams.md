...
<figure>
  <img src="/images/blog/ai-video-diagrams/pipeline.png" alt="A video production pipeline diagram, from brief through generation to client folder, with a human review gate before the render" />
...
<figure>
  <img src="/images/blog/ai-video-diagrams/character-sheet.png" alt="A character sheet diagram with a locked style block, action block and negative prompt list" />
  <figcaption>The character sheet. The locked style block is the part that stops face drift.</figcaption>
</figure>
...
<figure>
  <img src="/images/blog/ai-video-diagrams/decision-tree.png" alt="A decision tree diagram for choosing between Kling, Veo and custom pipelines based on motion, audio and character needs" />
  <figcaption>The decision tree. Naming the real models is what makes it useful.</figcaption>
</figure>
...
<figure>
  <img src="/images/blog/ai-video-diagrams/loop-dark.png" alt="A dark mode loop diagram showing the generate, review, refine flywheel around a central hub" />
  <figcaption>The same system after dark, generated by a token swap, not by hand.</figcaption>
</figure>
